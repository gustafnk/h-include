...
window.HInclude.HIncludeElement = window.HIncludeElement = (function() {
  ...
  var include = function(element, conditionalInclusionFnName, url, media, includeCallback) {
    if(conditionalInclusionFnName) {
      if(window[conditionalInclusionFnName]) {
        if(!window[conditionalInclusionFnName]()) {
          console.log('Condition not met')
          return;
        }
      } else {
        throw new Error('Conditional function not found');
      }
    }
  ...
  proto.connectedCallback = function() {
    ...
    include(this, this.getAttribute('when'), this.getAttribute('src'), this.getAttribute('media'), callback);
  };
